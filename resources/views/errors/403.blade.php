...
<html>
  ...
  @media screen and (max-width: 485px) {
    ...
    .background-color {
      background-color: rgba(8, 51, 88, 1) !important;
    }
    ...
    .secondary-text-color {
      color: rgba(255, 215, 23, 1) !important;
    }
  ...
  <body class="plain error-page-wrapper background-color background-image">
	...
	<div class="subheader primary-text-color">
		Sorry, no access. <br>
		Only privilaged users can access this page!
	</div>
	<hr>
    ...
    <p>
      ...
      If you think something is broken, kindly report a problem.
    </p>
	</div>
