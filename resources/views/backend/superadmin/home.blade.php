...
<head>
    ...
    <!-- Bootstrap 3.3.2 -->
    <link href="backend/css/bootstrap/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- Font Awesome Icons -->
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="" class="logo">
            ...
            <span class="logo-lg"><i class="fa fa-globe"></i> {{ $product_name }}</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu" style="margin-top: 3px;margin-right: -2px;">
                            <li><a href="#"><i class="fa fa-credit-card"></i> Company Profile</a></li>
